defmodule Day23 do
  ...
  def main do
    ...
    result = Enum.reduce_while(0..10000, %{
      map: paddedGrid,
      stepOrder: stepOrder,
      roundIndex: 0
    }, fn roundIndex, acc ->
      ...
      if newMap == map do
        {:halt, %{map: newMap, stepOrder: newStepOrder, roundIndex: roundIndex}}
      else
        {:cont, %{map: newMap, stepOrder: newStepOrder, roundIndex: roundIndex}}
      end    
